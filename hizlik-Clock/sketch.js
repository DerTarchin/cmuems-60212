...
function refreshScene() {
   ...
   fill(255);
   strokeWeight(0);
   ellipse(cwidth/2, sunHeight, cwidth/2, cwidth/2);

   strokeWeight(200);
   stroke(0);
   noFill();
   arc(cwidth/2, 0, cwidth*2, cwidth*2, TWO_PI, PI);
}
...
function Branch(hr, trunk=false) {
   ...
   if(trunk) {
      ...
      this.start = new Coord(cwidth/2, cheight-90);
      this.init();
   }
